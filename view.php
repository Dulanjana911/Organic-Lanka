            ...
            <div class="searchrow">
                <div class="left">
                    ...
                    <div class="shop-by-depertment" style="margin-top:2rem;">
                        <h2>price range</h2>
                        <ul>
                            <input type="range" name="price" id="price-input" min="1" max="1000" value="1000" oninput="getprice()" style="accent-color:#006A4E;border:none">
                            <div class="inrow" style="margin-top: 1.5rem;">
                                <div class="in">
                                    <h4>Rs.0</h4>
                                </div>
                                <div class="in">
                                    <h4>Rs.<span id="fnlp">1000</span></h4>
                                </div>
                                <div class="in">
                        ...
                        ?>
                                <div class="product" style="background:#fff">
                                    ...
                                    <div class="detail">
                                        ...
                                        <p class="price">Rs. <span class="ftrp"><?php echo $product['fa'] ?></span></p>
                                    </div>
                                </div>
                        <?php
                            }
