...
$(document).ready(function() {
    ...
    var textareaContent = $('#shrtdsc').val();

    // Define the options for the select box
    var options = [
        { value: 'G', text: 'G' },
        { value: 'KG', text: 'KG' },
        { value: 'Packets', text: 'Packets' },
        { value: 'Unit', text: 'Unit' },
        { value: 'Not Select', text: 'Not Select' }
    ];

    // Create a select element
    var selectElement = $('<select name="shrtdsc" id="shrtdsc" placeholder="Short Description *"></select>');
    ...
    // Set the textarea content as the selected value
    selectElement.val(textareaContent);

    // Replace the textarea with the select element
    $('#shrtdsc').replaceWith(selectElement);
});
</script>
