...
<div class="cartrow" id="catrow">
    <div class="gh">
        ...
        <div class="maincontainer2">
            <form action="#">
                <h1 style="color:#006A4E" class="mt3">Basic Details</h1>
                <div class="formrow">
                ...
                <h1 style="color:#006A4E" class="mt3">Business Details</h1>
                <div class="formrow">
                ...
                <?php } ?>
                <h1 style="color:#006A4E" class="mt3">Bank Details</h1>
                <div class="formrow">
                ...
                <h1 style="color:#006A4E" class="mt3">Upload Documents</h1>
