    ...
    <div class="headrow">
        ...
        <div class="wrap">
            <div class="detail" style="margin-bottom:4rem">
                <h3>Wallet Balance: Rs. <span><?php echo $wb; ?></span></h3>
            ...
            ?>
                <div class="detail" style="margin-bottom:4rem">
                    <h3>Requested: Rs. <span><?php echo $o['amount_r']; ?></span></h3>
                    <button style="background:#006A4E;color:#fff; padding:0.8rem; border-radius:5px" onclick="redirect_to('txn.php?sid=<?php echo $id;  ?>')">Approve Request</button>
                    <button style="background:#006A4E;color:#fff; padding:0.8rem; border-radius:5px" onclick="reject_req(<?php echo $id;  ?>)">Reject</button>
                </div>
            <?php } ?>
        </div>
