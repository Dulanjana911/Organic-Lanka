    ...
    <body>
                    ...
                    <div class="left">
                        ...
                        <div class="namebox">
                            <span class="price">
                                ...
                                <span class="tag">
                                    Rs. 1700 |&nbsp;<em class="crs">Rs. 100</em>
                                </span>
                            </span>
                        </div>
                    </div>
        ...
        <div class="mainbody-wrapper">
            <div class="navigation">
                <div class="photo">
                    <img src="assets/images/profile.jpg" alt="admin photo" />
                </div>
                <div class="top">
    <h2 id="greeting"></h2>
    <h2>Admin</h2>
...
<script>
    ...
    document.getElementById('greeting').textContent = getGreeting();
                ...
                <a href="fertilizer_form_views.php">
                        <li>
                ...
                <a href="Compensation_Claims.php">
                        <li>
                            <i class="fa fa-wpforms" aria-hidden="true"></i>
                            &nbsp;Compensation Claims
                ...
                <a href="fertilizer_issue_reporting_views.php">
                        <li>
                            <i class="fa fa-wpforms" aria-hidden="true"></i>
                            &nbsp;Fertilizer Issue Forms

                    </li>
                </a>
                <a href="Disease_Monitoring.php">
                        <li>
                            <i class="fa fa-wpforms" aria-hidden="true"></i>
                            &nbsp;Disese Monitoring
