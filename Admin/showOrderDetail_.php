                                                    ...
                                                    <ul class="order-dtsll">
                                                        ...
                                                        <li>
                                                            <div class="order-dt47">
                                                                <h4>Price</h4>
                                                                <div class="order-title">
                                                                    Rs. <?php echo $rw['qty'] * $rw['fa']; ?>
                                                                </div>
                                                                <div class="order-title">
                                                                    Rs. <?php echo $rw['delivered_qty'] * $rw['fa']; ?>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="total-dt">
                                                    <div class="total-checkout-group">
                                                        <div class="cart-total-dil">
                                                            <h4>Sub Total</h4>
                                                            <span>Rs. <?php echo $row['total_amt']; ?></span>
                                                        </div>
                                                        <div class="cart-total-dil pt-3">
                                                            <h4>Delivery Charges</h4>
                                                            <span>Rs. <?php echo $row['ship_fee_order']; ?></span>
                                                        </div>
                                                        <div class="cart-total-dil pt-3">
                                                            <h4>Payment Mode</h4>
                                                            <span><?php
                                                    ...
                                                    <div class="main-total-cart">
                                                        <h2>Total</h2>
                                                        <span>Rs. <?php echo $row['final_val']; ?></span>
                                                    </div>
                                                    <div class="main-total-cart">
                                                        <h2>User Paid</h2>
                                                        <span>Rs. <?php echo $row['final_val']; ?></span>
                                    ...
                                    <div class="total-dt">
                                        ...
                                        ?>
                                            <div class="total-checkout-group bt0">
                                                ...
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Ordered Price</h4>
                                                    <span>Rs. <?php echo $sellerInfo[$seller]["ordered"] ?></span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Received Price</h4>
                                                    <span style="word-wrap:break-word;">
                                                        Rs. <?php echo $sellerInfo[$seller]["received"] ?>
                                                    </span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Commission</h4>
                                                    <span style="word-wrap:break-word;">
                                                        Rs. <?php echo $sellerInfo[$seller]["commission"] ?>
                                                    </span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Final Payable</h4>
                                                    <span style="word-wrap:break-word;">
                                                        Rs. <?php echo ($sellerInfo[$seller]["received"] - $sellerInfo[$seller]["commission"]) ?>
                                                    </span>
                                                </div>
                                                <?php
