            ...
            <div class="bspace">
                ...
                <table style="margin-top:2rem;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> Rs.  <?php echo $tp; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> Rs.  <?php echo $rw['total_price']; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> Rs. <?php echo $total_com; ?></td>
                    </tr>
                    <?php
                    $h = 1;
                    ...
                    ?>
                        ...
                        <?php if ($stlinfo == "Done") { ?>
                            <tr>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;">Product <?php echo $h; ?>: </td>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;"><?php
                                                                                    echo "Expected Payment: Rs. " . $payable[$h];
                                                                                    ?></td>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;"><?php
                                                                                    echo "Paid: Rs. " . $payable2[$h];
                                                                                    ?></td>
                            </tr>
                    <?php }
                        $h++;
