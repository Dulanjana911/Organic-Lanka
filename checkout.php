...
?>
<style>
    /* CSS to hide the button initially */
    .next-step {
                                                    ...
                                                    ?>
                                                        <div class="field">
                                                            <div class="ui radio checkbox chck-rdio">
                                                                <input type="radio" name="fruit" tabindex="2" class="hidden" value="<?php echo $r['id'] ?>" />
                ...
                <div class="ul-wrapper">
                    ...
                    <?php foreach ($checkout as $product) { ?>
                        <div class="cart-item border_radius">
                            ...
                            <div class="cart-text">
                                ...
                                <div class="cart-item-price">Rs. <?php echo $product['fa'];
                    ...
                    <div class="total-checkout-group">
                        <div class="cart-total-dil">
                            <h4>Subtotal</h4>
                            <span>Rs. <?php echo $product['total']; ?></span>
                        </div>
                    ...
                    <div class="main-total-cart">
                        <h2>Total</h2>
                        <span>Rs. <?php echo $product['final_amt']; ?></span>
                    </div>
                    <div class="cktout">
...
<a href="https://sandbox.payhere.lk/pay/o12b00dc1?submit.x=100&submit.y=27" target="_blank">
    <img class="payhere-image" src="https://www.payhere.lk/downloads/images/pay_with_payhere.png" alt="Pay with PayHere">
</a>
</div>
...
<script>
    // JavaScript to show the button
    document.addEventListener('DOMContentLoaded', function() {
        var button = document.querySelector('.next-step');
        button.style.display = 'block'; // Change display to 'block' to show the button
    });
</script>
