        ...
        <div class="container">
            <div class="innerrow">
                ...
                <div class="right">
                    ...
                    <p class="pp-descp" >
                        <p style="    font-size: 1.8em;">Per : <?php echo $product['qty']; ?>   <?php echo $product['shrt_desc']; ?> </p>
                        ...
                        <ul>
                            <li>
                                <div class="main-price color-discount">
                                    Discount Price<span>Rs. <?php echo $product['fa']; ?></span>
                                </div>
                            </li>
                            <li>
                                <div class="main-price mrp-price">
                                    MRP Price<span>Rs. <?php echo $product['price']; ?></span>
                                </div>
                            </li>
                        </ul>
